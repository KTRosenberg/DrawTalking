...
# such a simpler form.
#
# In short, this file is provided to support prototyping additional language processing without changing the existing lingua.py.
# Alternatively, a more involved, but maybe more reliable approach longer-term would be to rewrite lingua.py entirely:
# Create a DSL and output the expected dependency tokens and structure. (There are advantages to targeting a simplified DSL instead of transformed English, such as verification.)
# 
