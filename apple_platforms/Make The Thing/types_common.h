...
#define STRMK(str) STRING_MAKE(str)
#define STRLN(str) str "\n"
#define STRIDTLN(str) "    " str "\n"

#define STRINGIFY_PREPROCESSED_SUB(x) #x
#define STRINGIFY_PREPROCESSED(x) STRINGIFY_PREPROCESSED_SUB(x)
