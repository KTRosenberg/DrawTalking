...
#ifdef TARGET_OS_OSX
#define DATA_ALIGN_CONSTANT __attribute__((aligned (256)))
#define DATA_ALIGN_DEVICE __attribute__((aligned (16)))
#else
#define DATA_ALIGN_CONSTANT  __attribute__((aligned (16)))
#define DATA_ALIGN_DEVICE  __attribute__((aligned (16)))
#endif
